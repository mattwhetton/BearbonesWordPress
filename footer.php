		...
		<div class="bb-grid md">
			...
			<div class="column one-third">
				...
				<div class="tmc-footer-links">
					...
					<ul class="unstyled inline">
						<li class="inline-item">
							<a target="_blank" title="Take Me Cooking Press Kit" target='_blank' href="https://drive.google.com/drive/folders/1FRU_5mGthJM4dlVF0mwUazBdNkrsAxgm?usp=sharing"
							 class="link white">Press Kit</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="column one-third">
				<div class="footer-sitemap">
					<ul class="inline">
						...
						<li class="inline-item">
							<a target="_blank" title="Take Me Cooking on YouTube" target='_blank' href="https://www.youtube.com/channel/UC0fsFTR2AiHZ3mElYyv-Yzg"
							 class="link white">
